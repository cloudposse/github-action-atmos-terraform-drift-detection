...
https://atmos.tools/deprecated/github-actions/atmos-terraform-drift-detection for the equivalent
built-in approach (a scheduled workflow running `atmos terraform plan`) and how to move your workflow over.
